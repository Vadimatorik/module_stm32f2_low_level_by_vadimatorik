...
%	\begin{itemize}
%		\item общие описание библиотеки, ;
%		\item 
	...
	\input{chapter/philosophy/main.tex}				% Знакомство с библиотекой.
	\input{chapter/egreement/main.tex}				% Соглашение о написании и оформлении библиотеки.
\end{document}